...
class TicTacToe:
    ...
    def check_for_win(self):
        ...
        # Draw if no win combination was found and board is full
    ...
    def __str__(self):
        ...
        for tile in range(9):
            ...
            if (self.board >> (self.PLAYER_WHITE + tile)) & 1 == 1:
                s += "X"
            elif (self.board >> (self.PLAYER_BLACK + tile)) & 1 == 1:
                s += "O"
            else:
                s += "-"
